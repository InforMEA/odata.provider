...
INSERT INTO `informea_contacts` VALUES
  ('471d81c2-4a22-4574-9fd1-0341797ec6de','AL','Mr.','John','Doe','Director','Biodiversity Directorate','department 1','Primary','address 1','email1@moe.gov.al','+4 224 3578','+355',1,'2016-03-29 17:21:54')
 ,('c6626713-3a16-485c-952c-718802a21b5b','AD','Mrs.','Josep','Christiansen','Desk Officer de l\'Environnement','Département du Patrimoine naturel','department 3',NULL,NULL,'email2@govern.ad','+ 875 700','+376 869',0,'2016-03-30 13:21:54')
 ,('c9b98891-6347-4755-9cdb-a08268849abb','DZ','Ms.','Chorn','Mali','Sous directrice','Direction Générale des Forêts','department 2',NULL,'address 2','email3@dgf.gov.dz','','',0,'2016-02-10 14:21:54')
 ,('e949e7b9-4a45-4ed0-b06e-679e55c31e5e','AR',NULL,'Seren Janir',NULL,'Subdirectora General de Medio Ambiente','Dirección General de Asuntos Ambientales,',NULL,NULL,NULL,'email4@mrecic.gov.ar','','',0,'2016-03-30 13:21:54')
 ,('ec8b6c87-aa11-4297-9c89-b25320a54827','AG',NULL,NULL,'Philm A. JAMES','Deputy Chief Fisheries Officer','Fisheries Division','department 4',NULL,NULL,'email5@gmail.com','','',0,'2016-03-30 13:21:54');
UNLOCK TABLES;
...
INSERT INTO `informea_contacts_treaties` VALUES
  ('471d81c2-4a22-4574-9fd1-0341797ec6de-cites','471d81c2-4a22-4574-9fd1-0341797ec6de','cites')
 ,('471d81c2-4a22-4574-9fd1-0341797ec6de-cms','471d81c2-4a22-4574-9fd1-0341797ec6de','cms')
 ,('c6626713-3a16-485c-952c-718802a21b5b-cms','c6626713-3a16-485c-952c-718802a21b5b','cms')
 ,('c9b98891-6347-4755-9cdb-a08268849abb-cms','c9b98891-6347-4755-9cdb-a08268849abb','cms')
 ,('e949e7b9-4a45-4ed0-b06e-679e55c31e5e-cms','e949e7b9-4a45-4ed0-b06e-679e55c31e5e','cms')
 ,('ec8b6c87-aa11-4297-9c89-b25320a54827-cms','ec8b6c87-aa11-4297-9c89-b25320a54827','cms');
UNLOCK TABLES;
...
INSERT INTO `informea_country_reports` VALUES
  ('96e420cc-fb81-426b-a0e1-4571c255a5d0','ramsar','AL','2012-01-01','http://www.ramsar.org/node/14398','2015-05-27 08:07:01')
 ,('e802070d-eece-4348-ae0a-aba6d1dcd58e','ramsar','AL','2012-01-01','http://www.ramsar.org/node/14399','2015-05-27 08:06:24')
 ,('f2e868e6-ed35-45b2-8a2a-602fe1d6aa12','ramsar','AG','2008-01-01','http://www.ramsar.org/node/14408','2015-05-27 08:17:06');
UNLOCK TABLES;
...
INSERT INTO `informea_country_reports_documents` VALUES
  ('14408-1','96e420cc-fb81-426b-a0e1-4571c255a5d0',NULL,'http://www.ramsar.org/sites/default/files/documents/pdf/cop10/cop10_nr_antigua.pdf','application/pdf','en','cop10_nr_antigua.pdf')
 ,('17659-2','96e420cc-fb81-426b-a0e1-4571c255a5d0',NULL,'http://www.ramsar.org/sites/default/files/documents/pdf/cop10/cop10_nr_algeria.pdf','application/pdf','fr','cop10_nr_algeria.pdf');
UNLOCK TABLES;
...
INSERT INTO `informea_country_reports_title` VALUES
  ('96e420cc-fb81-426b-a0e1-4571c255a5d0-en','96e420cc-fb81-426b-a0e1-4571c255a5d0','en','COP11 National Reports: Albania - Section 4')
 ,('96e420cc-fb81-426b-a0e1-4571c255a5d0-fr','96e420cc-fb81-426b-a0e1-4571c255a5d0','fr','Rapports nationaux COP11 : Algérie')
...
INSERT INTO `informea_decisions` VALUES
  ('2c776b76-57d3-4a46-a1be-c254976a0ee2','http://www.ramsar.org/node/31099','resolution','active','1234','ramsar','2015-07-03 10:45:00','af2078a9-357d-4b12-8f44-fdd1e63ea63f','meeting1','http://chm.pops.int/linkclick.aspx?link=404&amp;amp;tabid=276&amp;amp;language=en-us',3,'2015-12-14 17:21:55')
 ,('55e618ce-a88d-4e35-9ae2-08c6bccbb9c6','http://www.ramsar.org/node/31100','resolution','active','n/a','ramsar','2015-07-03 11:00:00','af2078a9-357d-4b12-8f44-fdd1e63ea63f',NULL,NULL,2,'2016-03-03 10:22:38')
 ,('95d1ad86-5a21-46a7-a963-cde0d844d0fb','http://www.ramsar.org/node/31101','resolution','active','n/a','ramsar','2015-07-03 11:00:00','af2078a9-357d-4b12-8f44-fdd1e63ea63f',NULL,NULL,1,'2015-12-14 17:21:41');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_content` VALUES
  ('16285','2c776b76-57d3-4a46-a1be-c254976a0ee2','en','<p>Resolution on the Framework for the implementation of the Convention and priorities for attention 1991-1993</p>')
 ,('19532','2c776b76-57d3-4a46-a1be-c254976a0ee2','fr','<p>adoptées par la Convention sur la diversité biologique (CDB), et leur pertinence pour la Convention de Ramsar</p>');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_documents` VALUES
  ('14408-1','2c776b76-57d3-4a46-a1be-c254976a0ee2',NULL,'http://chm.pops.int/Portals/0/download.aspx?d=UNEP-POPS-COP.4-SC-4-28.Spanish.doc','application/msword','en','UNEP-POPS-COP.4-SC-4-28.Spanish.doc')
 ,('17659-2','2c776b76-57d3-4a46-a1be-c254976a0ee2',NULL,'http://chm.pops.int/Portals/0/download.aspx?d=UNEP-POPS-COP.4-SC-4-28.French.doc','application/msword','fr','UNEP-POPS-COP.4-SC-4-28.French.doc');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_keywords` VALUES
  ('1','2c776b76-57d3-4a46-a1be-c254976a0ee2','http://www.ramsar.org/taxonoomy/term/','Wetland values')
 ,('2','2c776b76-57d3-4a46-a1be-c254976a0ee2','http://www.ramsar.org/taxonoomy/term/','Urbanization');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_longtitle` VALUES
  ('1','2c776b76-57d3-4a46-a1be-c254976a0ee2','en','Annex to Doc.C.4.15')
 ,('2','2c776b76-57d3-4a46-a1be-c254976a0ee2','fr','Annex to Doc.C.4.14');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_summary` VALUES
  ('16285','2c776b76-57d3-4a46-a1be-c254976a0ee2','en','<p>Resolution on the Framework</p>')
 ,('19532','2c776b76-57d3-4a46-a1be-c254976a0ee2','fr','<p>adoptées par la Convention sur la diversité biologique (CDB)');
UNLOCK TABLES;
...
INSERT INTO `informea_decisions_title` VALUES
  ('1','2c776b76-57d3-4a46-a1be-c254976a0ee2','en','Doc.C.4.15')
 ,('2','2c776b76-57d3-4a46-a1be-c254976a0ee2','fr','Doc.C.4.14');
UNLOCK TABLES;
...
INSERT INTO `informea_meetings_description` VALUES
  ('af2078a9-357d-4b12-8f44-fdd1e63ea63f-en','af2078a9-357d-4b12-8f44-fdd1e63ea63f','en','<p>The 12th Meeting of the Conference of the Contracting Parties to the Ramsar Convention on Wetlands (COP12)</p>')
 ,('af2078a9-357d-4b12-8f44-fdd1e63ea63f-es','af2078a9-357d-4b12-8f44-fdd1e63ea63f','es','<p>La 12ª Reunión de la Conferencia de las Partes Contratantes de la Convención de Ramsar sobre los Humedales (COP12)</p>')
 ,('af2078a9-357d-4b12-8f44-fdd1e63ea63f-fr','af2078a9-357d-4b12-8f44-fdd1e63ea63f','fr','<p>La 12e Session de la Conférence des Parties contractantes à la Convention de Ramsar sur les zones humides (COP12)</p>');
UNLOCK TABLES;
...
INSERT INTO `informea_meetings_title` VALUES
  ('5bdb02b0-debe-4689-852d-9d9a96fd63eb-en','5bdb02b0-debe-4689-852d-9d9a96fd63eb','en','11th Meeting of the Conference of the Parties')
 ,('5bdb02b0-debe-4689-852d-9d9a96fd63eb-es','5bdb02b0-debe-4689-852d-9d9a96fd63eb','es','11ª Reunión de la Conferencia de las Partes')
 ,('5bdb02b0-debe-4689-852d-9d9a96fd63eb-fr','5bdb02b0-debe-4689-852d-9d9a96fd63eb','fr','11e Session de la Conférence des Parties')
 ,('af2078a9-357d-4b12-8f44-fdd1e63ea63f-en','af2078a9-357d-4b12-8f44-fdd1e63ea63f','en','12th Meeting of the Conference of the Parties')
 ,('af2078a9-357d-4b12-8f44-fdd1e63ea63f-es','af2078a9-357d-4b12-8f44-fdd1e63ea63f','es','12ª Reunión de la Conferencia de las Partes')
 ,('af2078a9-357d-4b12-8f44-fdd1e63ea63f-fr','af2078a9-357d-4b12-8f44-fdd1e63ea63f','fr','12e Session de la Conférence des Parties');
UNLOCK TABLES;
...
INSERT INTO `informea_national_plans` VALUES
  ('4298e0ab-c687-4cbe-b849-f3a16d63284e','stockholm','AL','2007-02-12','http://www.cbd.int/doc/world/ve/ve-nbsap-01-es.pdf','nip','2015-04-22 09:21:43')
 ,('a6f6ecc6-7a39-4aac-b488-f3618fd3d882','stockholm','TZ','2006-06-12','url1','nip','2015-08-28 15:03:50');
UNLOCK TABLES;
...
INSERT INTO `informea_national_plans_documents` VALUES
  ('1','4298e0ab-c687-4cbe-b849-f3a16d63284e','path1','http://chm.pops.int/Portals/0/download.aspx?d=UNEP-POPS-NIP-Algeria-1.French.pdf','application/pdf','en','UNEP-POPS-NIP-Algeria-1.French.pdf')
 ,('2','4298e0ab-c687-4cbe-b849-f3a16d63284e','path2','http://chm.pops.int/Portals/0/download.aspx?d=UNEP-POPS-NIP-Albania-1.English.pdf','application/pdf','fr','UNEP-POPS-NIP-Albania-1.English.pdf');
UNLOCK TABLES;
...
INSERT INTO `informea_national_plans_title` VALUES
  ('1','4298e0ab-c687-4cbe-b849-f3a16d63284e','fr','Plan National de Mise en oeuvre – Convention de Stockholm')
 ,('2','4298e0ab-c687-4cbe-b849-f3a16d63284e','es','Plan nacional de Aplicación del Convenio de Estocolmo')
 ,('3','4298e0ab-c687-4cbe-b849-f3a16d63284e','en','NATIONAL IMPLEMENTATION PLAN (NIP) FOR POLLUTANTS (POPs)');
UNLOCK TABLES;
...
INSERT INTO `informea_sites` VALUES
  ('4cbc51ee-1b32-49eb-bbf0-6c7b15d33f0f','whc','AT','whc','http://whc.unesco.org/en/list/1363',47.278333333,8.207500000,'2012-05-14 11:04:45')
 ,('bdf4045a-ecad-42d8-a856-f1e90f0632ec','whc','BR','whc','http://whc.unesco.org/en/list/275',-28.543333330,-54.265833330,'2012-05-14 11:04:45');
UNLOCK TABLES;
...
INSERT INTO `informea_sites_name` VALUES
  ('1','4cbc51ee-1b32-49eb-bbf0-6c7b15d33f0f','en','Prehistoric Pile dwellings around the Alps')
 ,('2','4cbc51ee-1b32-49eb-bbf0-6c7b15d33f0f','es','Kluane / Wrangell-St Elias / Glacier Bay / Tatshenshini-Alsek')
 ,('3','4cbc51ee-1b32-49eb-bbf0-6c7b15d33f0f','fr','Jesuit Missions of the Guaranis Missoes (Brazil)');
UNLOCK TABLES;
